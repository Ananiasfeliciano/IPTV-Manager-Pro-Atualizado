...
type IconName = 'home' | 'users' | 'calendar' | 'server-stack' | 'play-circle' | 'user-group' | 'currency-dollar' | 'exclamation-circle' | 'check-circle' | 'exclamation-triangle' | 'x-mark' | 'whatsapp' | 'light-bulb' | 'chart-pie' | 'sparkles' | 'qr-code' | 'arrow-path' | 'shield-check' | 'banknotes' | 'bars-3' | 'pencil';
